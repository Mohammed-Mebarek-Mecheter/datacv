...
import { Crown, Eye, EyeOff, Star, GitBranch, Palette } from "lucide-react";
...
export const BasicInfoPanel: React.FC = () => {
    ...
    return (
        <div className="max-h-full space-y-6 overflow-y-auto">
            ...
            {/* Template Relationship & Variants */}
            <Card>
                <CardHeader>
                    <CardTitle>Template Relationship & Variants</CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <FormField
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel>Base Template ID</FormLabel>
                                    <FormControl>
                                        <Input
                                            {...field}
                                            placeholder="Leave empty if not a variant"
                                        />
                                    </FormControl>
                                    <FormDescription>
                                        If this is a variant, specify the base template ID
                                    </FormDescription>
                                    <FormMessage />
                                </FormItem>
                            )}
                            ...
                            render={({ field }) => (
                                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                                    <div className="space-y-0.5">
                                        ...
                                        <FormDescription>
                                            Is this template a variant of another template?
                                        </FormDescription>
                                    </div>
                                    <FormControl>
                                        <Switch
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <Input
                                                    {...field}
                                                    placeholder="Variant name (e.g., 'Dark Mode')"
                                                />
                                            </FormControl>
                                            <FormDescription>
                                                Name for this template variant
                                            </FormDescription>
                                            <FormMessage />
                                        </FormItem>
                                    )}
                    ...
                    {(form.watch("parentTemplateId") || form.watch("baseTemplateId")) && (
                        <div className="rounded-lg bg-blue-50 p-3">
                            <p className="text-blue-800 text-sm">
                                This template has a relationship with another template. Changes to the parent/base may affect this template.
                            </p>
                        </div>
                    )}
                </CardContent>
            ...
            <Card>
                ...
                <CardContent className="space-y-4">
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormDescription>
                                        Comma-separated list of target job titles
                                    </FormDescription>
                                    <FormMessage />
                                </FormItem>
                            )}
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                <FormLabel>Target Company Types</FormLabel>
                                <FormControl>
                                    <Input
                                        placeholder="startup, enterprise, consulting"
                                        value={field.value?.join(", ") || ""}
                                        onChange={(e) => {
                                            const values = e.target.value
                                                .split(",")
                                ...
                                <FormDescription>
                                    Comma-separated list of target company types
                                </FormDescription>
                                <FormMessage />
                            </FormItem>
                        )}
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input
                                            {...field}
                                            placeholder="SEO title for template"
                                        />
                                    </FormControl>
                                    <FormDescription>
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input
                                            {...field}
                                            placeholder="SEO description for template"
                                        />
                                    </FormControl>
                                    <FormDescription>
                ...
                <CardContent>
                    <div className="flex flex-wrap gap-2">
                        ...
                        {form.watch("accessLevel") !== "public" && (
                            <Badge variant="outline">{form.watch("accessLevel")}</Badge>
                        )}
                    </div>
                </CardContent>
            </Card>
